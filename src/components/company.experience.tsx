                        ...
                        {showIndex.find(x => x.index === i) && (
                          <div>
                            ...
                            <div className="d-flex">
                              {x.technologies?.map(x => (
                                <div
                                  className=" border-radius-3 btn btn-primary btn-small d-flex justify-content-left me-2 mt-3 py-0 align-items-center"
